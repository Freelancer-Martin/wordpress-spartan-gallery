 ...
 $fields[] = array(
     ...
     'fields' => array(
         ...
         array(
             ...
             'options'   => array(
                 'value-1' => plugins_url( ) . '/spartan-gallery/admin/img/FlexFreewallTable.png',
                 'value-2' => plugins_url( )  . '/spartan-gallery/admin/img/ImageFreewallGrid.png',
                 'value-3' => plugins_url( ) . '/spartan-gallery/admin/img/NestedFreewallGrid.png',
                 'value-4' => plugins_url( ) . '/spartan-gallery/admin/img/PinterestFreewallGrid.png',
								 'value-5' => plugins_url( ) . '/spartan-gallery/admin/img/hexagon_layout.jpg',
								 'value-6' => plugins_url( ) . '/spartan-gallery/admin/img/spartan_3D_layout.png',
